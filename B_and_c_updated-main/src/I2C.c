...
void I2C_Initialization(void){
	...
	// set system clock as the clock source for I2C
	...
	// set values in timing register
	I2C1->TIMINGR |= 7 << I2C_TIMINGR_PRESC_POS;
	I2C1->TIMINGR |= 15 << I2C_TIMINGR_SCLDEL_POS;
	I2C1->TIMINGR |= 15 << I2C_TIMINGR_SDADEL_POS;
	I2C1->TIMINGR |= 49 << I2C_TIMINGR_SCLH_POS;
	I2C1->TIMINGR |= 56 << I2C_TIMINGR_SCLL_POS;
